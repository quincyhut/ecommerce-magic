...
const Banner = ({ title, subtitle, btnText, offerContent, imgSrc1, imgSrc2 }: IBanner) => {
    ...
    return (
        <div className={`bg-white sm:bg-zinc-100 px-0 h-[650px] overflow-hidden flex flex-col-reverse gap-1 sm:gap-5 md:flex-col-reverse sm:flex-row lg:flex-row items-start md:justify-center md:items-start lg:justify-between lg:items-center sm:px-20 text-black`}>
            <div>
