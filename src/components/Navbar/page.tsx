...
const NavbarComp = () => {
  ...
  return (
    <div className="flex-center">
      <div className='py-1 w-full md:w-[75vw]'>
        <Navbar fluid rounded>
          <div className="w-full flex-between">
            <div className="flex-center border-0 sm:border sm:border-slate-700 ">
              ...
              <input type="search" placeholder='Search items' className="text-sm border-none" style={{ boxShadow: 'none' }} onChange={handleSearch} />
            </div>
